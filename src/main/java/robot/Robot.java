...
import robot.subsystems.Collector;
import robot.subsystems.DriveTrain;
import robot.subsystems.Elevator;
import robot.subsystems.ElevatorPitch;


import robot.commands.AutonomousLeft;
import robot.commands.AutonomousMiddle;
import robot.commands.AutonomousRight;
import robot.commands.GetFieldPosition;
import robot.commands.PassAutoLineFromMiddle;
...
//		m_smartDashboardUpdater.updateDashboard();
	 ...
	 *
	 * <p>
	 * You can add additional auto modes by adding additional robot.commands to the
	 * chooser code above (like the commented example) or additional comparisons to
	 * the switch structure below with additional strings & robot.commands.
	 */
	@Override
